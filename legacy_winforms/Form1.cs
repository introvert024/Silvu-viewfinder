...
namespace SilvuViewfinder
{
    public partial class Form1 : Form, ISilvuHost
    {
        ...
        static readonly UiPalette DarkPalette = new(
            windowBackground: Color.FromArgb(16, 29, 34), // #101d22
            surface: Color.FromArgb(22, 37, 42), // #16252a
            surfaceAlt: Color.FromArgb(28, 45, 50), // slightly lighter than surface
            cardBackground: Color.FromArgb(22, 37, 42),
            border: Color.FromArgb(35, 63, 72), // #233f48
            textPrimary: Color.FromArgb(241, 245, 249), // slate-100
            textMuted: Color.FromArgb(148, 163, 184), // slate-400
            accent: Color.FromArgb(240, 66, 66), // #f04242
            accentSoft: Color.FromArgb(46, 26, 28), // Faint red
            viewportBackground: Color.FromArgb(16, 29, 34), // #101d22
            hudBackground: Color.FromArgb(22, 37, 42), // #16252a
            hudText: Color.FromArgb(203, 213, 225), // slate-300
            success: Color.FromArgb(16, 185, 129), // emerald-500
            warning: Color.FromArgb(249, 115, 22) // orange-500
        );
